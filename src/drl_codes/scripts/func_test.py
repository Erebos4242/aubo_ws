...
net = CNNActorCritic(1, 1)
print(net)

input_data = torch.randn(1, 1, 84, 84)
output = net.pi(input_data)
points = [i for i in output[0].loc.data]
print(points)
points[0] = points[0] * 0.6 + 0.2
points[1] = points[1] * 0.6 - 0.3
points[2] = points[2] * 0.6 + 0.2
points[3] = points[3] * 0.6 - 0.3
print(points)
